...
TRAJECTORY_BUILDER_2D.real_time_correlative_scan_matcher.linear_search_window = 0.001
...
TRAJECTORY_BUILDER_2D.ceres_scan_matcher.rotation_weight = 48.
...
POSE_GRAPH.optimization_problem.acceleration_weight = 1.1e1
POSE_GRAPH.optimization_problem.rotation_weight = 1.6e3
